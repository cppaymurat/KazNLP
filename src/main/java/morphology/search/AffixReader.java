    ...
    public void read(){
        BufferedReader sn = new BufferedReader(
                new InputStreamReader(
                        this.getClass().getResourceAsStream("C:\\Users\\ZZZ\\Desktop\\Project_KazNU\\toolsKazanalysis\\toolsKazanalysis\\src\\main\\resources\\affixJSON\\noun\\affixSoftNoun.json")));
        BufferedReader hn = new BufferedReader(
                new InputStreamReader(
                        this.getClass().getResourceAsStream("C:\\Users\\ZZZ\\Desktop\\Project_KazNU\\toolsKazanalysis\\toolsKazanalysis\\src\\main\\resources\\affixJSON\\noun\\affixHardNoun.json")));
        BufferedReader hv = new BufferedReader(
                new InputStreamReader(
                        this.getClass().getResourceAsStream("C:\\Users\\ZZZ\\Desktop\\Project_KazNU\\toolsKazanalysis\\toolsKazanalysis\\src\\main\\resources\\affixJSON\\verb\\affixHardVerb.json")));
        BufferedReader sv = new BufferedReader(
                new InputStreamReader(
                        this.getClass().getResourceAsStream("C:\\Users\\ZZZ\\Desktop\\Project_KazNU\\toolsKazanalysis\\toolsKazanalysis\\src\\main\\resources\\affixJSON\\verb\\affixSoftVerb.json")));
